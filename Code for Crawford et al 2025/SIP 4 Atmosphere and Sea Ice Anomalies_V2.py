...
bboxname = ['GulfOfAlaska','Alaska','BeaufortSea','Scandinavia','WesternRussia','CentralSiberia'] 
bbox = [[50,60,-160,-140],[60,70,-170,-140],[70,80,-160,-125],[55,70,10,40],[55,70,40,60],[55,70,60,90]]
...
for vi in [0]: #range(len(vvalue)):
    ...
    ### Write to File ###
    odf.to_csv(outpath+"/ERA5_and_SST_Avgs_forbboxes_forevents_V3-Oct-Janslp.csv", index=False)
